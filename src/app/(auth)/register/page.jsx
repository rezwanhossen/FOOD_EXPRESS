        ...
        <div className="hidden lg:flex bg-slate-900 p-16 flex-col justify-between relative overflow-hidden">
          ...
          <div className="relative z-10">
            ...
            <h2 className="text-4xl font-black text-white mt-20 leading-tight">
              Join the <br />
              <span className="text-orange-500">Foodie Community.</span>
            </h2>
            <p className="text-gray-400 mt-6 max-w-xs">
              Create an account to save your favorite meals and get faster
              deliveries.
            </p>
          </div>
        ...
        <div className="p-8 md:p-16">
          <div className="max-w-md mx-auto">
            ...
            <div className="space-y-4">
              <div className="space-y-1">
                ...
                <div className="relative border-b-2 border-gray-100 focus-within:border-orange-500 transition-all">
                  ...
                  <input
                    ...
                    className="w-full pl-8 pr-4 py-3 bg-transparent outline-none font-medium"
                  />
                </div>
              </div>
              ...
              <div className="pt-6">
                <button className="w-full py-5 bg-orange-500 text-white rounded-2xl font-black shadow-xl shadow-orange-500/20 flex items-center justify-center gap-3 uppercase text-sm tracking-widest active:scale-95 transition-transform">
            ...
            <div>
              <div className="flex items-center justify-center gap-2 py-4 border border-gray-100 rounded-2xl font-bold text-slate-700 text-xs uppercase tracking-wider cursor-pointer hover:bg-gray-50 transition-colors">
                <svg
                  width="18"
                  height="18"
                  viewBox="0 0 24 24"
